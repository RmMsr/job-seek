...
_SYSTEM = (
    ...
    "employer and has a URL distinct from every other posting's (its own ID "
    "or slug) — treat that distinct URL as the decisive signal. Similar or "
    "overlapping titles alone (e.g. several seniority or specialization "
    "variants on the same team, like \"Engineering Manager (Red Team)\" and "
    "\"Technical Project Manager, Red Team\") do NOT make a link a category "
    "page; real job boards routinely list many distinct postings with "
    "overlapping title wording, and each still counts individually as long "
    "as its URL is distinct. Be wary instead of links that only name a role "
    "and a location with no employer attached (e.g. \"Machine Learning "
    "Engineer Jobs in Oslo\", or a URL like \"/jobs/ai-engineer-jobs-in-oslo\""
    ") — these are category or search-filter pages that themselves list "
    "postings for that role, not a specific posting, even though they look "
    "job-like. "
